...
![](https://qn.hushhw.cn/20180402_02.png)

首先，主串"BBC ABCDAB ABCDABCDABDE"的第一个字符与模式串"ABCDABD"的第一个字符，进行比较。因为B与A不匹配，所以模式串后移一位。

（2）

![](https://qn.hushhw.cn/20180402_03.png)

因为B与A又不匹配，模式串再往后移。

（3）

![](https://qn.hushhw.cn/20180402_04.png)

就这样，直到主串有一个字符，与模式串的第一个字符相同为止。

（4）

![](https://qn.hushhw.cn/20180402_05.png)

接着比较主串和模式串的下一个字符，还是相同。

（5）

![](https://qn.hushhw.cn/20180402_06.png)

直到主串有一个字符，与模式串对应的字符不相同为止。

（6）

![](https://qn.hushhw.cn/20180402_07.png)

这时，最自然的反应是，将模式串整个后移一位，再从头逐个比较。这样做虽然可行，但是效率很差，因为你要把"搜索位置"移到已经比较过的位置，重比一遍。

（7）

![](https://qn.hushhw.cn/20180402_08.png)
...
![](https://qn.hushhw.cn/20180402_14.png)
...
![](https://qn.hushhw.cn/20180402_15.png)
