...
核心部分的交换技术 P11-15
  ...
  - **报文交换** 整个报文传送到相邻结点，全部存储下来之后查询转发表，转发到下一个结点。
    {% qnimg Snipaste_2019-01-12_19-21-39.png %}
    {% qnimg 20180105203650888.png %}
...
{% qnimg Snipaste_2019-03-14_17-33-35.png %}
...
{% qnimg Snipaste_2019-03-14_17-37-40.png %}
...
2. PPP协议的帧格式
     {% qnimg Snipaste_2019-01-12_19-34-19.png %}
...
3. 透明传输的实现方法
 ...
 - **零比特填充**——PPP使用同步传输
     只要发现有5个连续的1，则立即填入一个0
        {% qnimg Snipaste_2019-01-12_19-35-15.png %}
...
{% qnimg 20180107023041372.jpg %}
{% qnimg 20180107023943820.jpg %}
...
1. IP数据报格式
   ...
   {% qnimg 20180107045436621.png %}
   {% qnimg 20180107045539001.png %}
